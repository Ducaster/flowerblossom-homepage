...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <source src="/videos/flowerblossom-hero.mp4" type="video/mp4" />
      </video>
      ...
      <div className="text-center px-6 py-20 relative z-10">
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl mb-6 drop-shadow-lg" style={{ color: '#f5f0e6' }}>
        ...
        <p className="text-xl md:text-2xl max-w-3xl mx-auto drop-shadow-md" style={{ color: '#f5f0e6', opacity: 0.95 }}>
